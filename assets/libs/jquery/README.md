...
If upgrading, please see the [blog post for 3.6.0](https://blog.jquery.com/2022/03/02/jquery-3-6-0-released/). This includes notable differences from the previous version and a more readable changelog.
